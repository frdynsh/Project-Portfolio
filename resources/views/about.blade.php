            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
                <div class="space-y-6">
                    ...
                    <div class="flex gap-4 pt-4">
                        <a href="https://github.com/frdynsh/" target="_blank" class="p-3 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-blue-400 transition text-gray-400 hover:text-white">
                        ...
                        <a href="https://www.linkedin.com/in/ferdi-yansah/" target="_blank" class="p-3 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-blue-400 transition text-gray-400 hover:text-white">
